...
class CasadiOptimizer(object):
    ...
    def equal_constraints(self, states, controls, f):
        ...
        # dynamic equation constraint x_k+1 = x_k + f(x,u)*T
        ...
        for i in range(self.predict_horizon + 1):
            ...
            # g.append(closest_distance_left_boundary[2]) #Not used any more due to computation cost.

            g.append(closest_distance_right_boundary[0])
            g.append(closest_distance_right_boundary[1])
            #g.append(closest_distance_right_boundary[2]) #Not used any more due to computation cost.
